...
namespace RefactoringDemo8a.Tests
{
    [TestClass]
...
You earned <em>7</em> frequent renter points";
        ...
        ////[TestMethod]
        ////public async Task RazorLight_Test()
        ////{
        ...
        ////    string result = await engine.CompileRenderStringAsync("templateKey", template, new { Name = "John Doe" });
